...
subject_plot <- plot_subject_data(IndividualNetworks, "1003", Individual_colors)
subject_plot

## Plotting Individualized Networks by Subject:

Subject_1003_plot <- create_plot("1003", IndividualNetworks, "SubjectID","#771185")
Subject_1003_plot

## Plotting Individualized Networks by Session: 
...
## Compairing MetaAnalysisBased ROI to Group Based Networks to Individualized Networks:

## VISUAL NETWORKS:

# Updating r_Fusiform_plot to have a title "MetaAnalysisBased ROI: r_Fusiform" and subtitle "Activity (Faces > Shapes) by session":
r_Fusiform_plot <- r_Fusiform_plot + labs(title = "MetaAnalysisBased ROI: r_Fusiform", subtitle = "Activity (Faces > Shapes) by session")

# Updating VIS_2_plot to have a bold title "Group Based Networks: VIS-2" and subtitle "Activity (Faces > Shapes) by session":
VIS_2_plot <- VIS_2_plot + labs(title = "Group Based Network: VIS-2", subtitle = "Activity (Faces > Shapes) by session")

# Updating VIS_C_plot to have a bold title "Individualized Network: VIS-C" and subtitle "Activity (Faces > Shapes) by session":
VIS_C_plot <- VIS_C_plot + labs(title = "Individualized Network: VIS-C", subtitle = "Activity (Faces > Shapes) by session")
...
DAN_1_plot <- DAN_1_plot + labs(title = "Group Based Network: DAN-1", subtitle = "Activity (Faces > Shapes) by session")

# Updating dATN_B_plot to have a title "Group Based Networks: dATN-B" and subtitle "Activity (Faces > Shapes) by session":
dATN_B_plot <- dATN_B_plot + labs(title = "Individualized Network: dATN-B", subtitle = "Activity (Faces > Shapes) by session")

DAN_1_plot + dATN_B_plot

## Plotting other individualized networks by session:

VIS_P_plot <- create_by_session_plot("VIS-P", IndividualNetworks, "Network","#aa467d")
VIS_P_plot

PM_PPr_plot <- create_by_session_plot("PM-PPr", IndividualNetworks, "Network","#42e7ce")
PM_PPr_plot

SMOT_A_plot <- create_by_session_plot("SMOT-A", IndividualNetworks, "Network","#4991af")
SMOT_A_plot

SMOT_B_plot <- create_by_session_plot("SMOT-B", IndividualNetworks, "Network","#1bb3f2")
SMOT_B_plot

AUD_plot <- create_by_session_plot("AUD", IndividualNetworks, "Network","#e7d7a5")
AUD_plot

dATN_A_plot <- create_by_session_plot("dATN-A", IndividualNetworks, "Network","#0a7021")
dATN_A_plot

CG_OP_plot <- create_by_session_plot("CG-OP", IndividualNetworks, "Network","#b859fb")
CG_OP_plot

SAL_PMN_plot <- create_by_session_plot("SAL_PMN", IndividualNetworks, "Network","#febceb")
SAL_PMN_plot

FPN_A_plot <- create_by_session_plot("FPN-A", IndividualNetworks, "Network","#f09321")
FPN_A_plot

FPN_B_plot <- create_by_session_plot("FPN-B", IndividualNetworks, "Network","#e4e400")
FPN_B_plot

DN_A_plot <- create_by_session_plot("DN-A", IndividualNetworks, "Network","#643149")
DN_A_plot

DN_B_plot <- create_by_session_plot("DN-B", IndividualNetworks, "Network","#cd3d4d")
DN_B_plot

LANG_plot <- create_by_session_plot("LANG", IndividualNetworks, "Network","#0b2fff")
LANG_plot
